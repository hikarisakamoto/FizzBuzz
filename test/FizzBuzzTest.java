...
public class FizzBuzzTest {
    ...
    @Test // 1 - 100
    public void deveTestarGeracaoParaListaCompletaDe1a100() {
        FizzBuzz fizzBuzz = new FizzBuzz();
        fizzBuzz.gerarListaCompletaAte100();
    }

    @Test // Stage 2
    public void deveTestarGeracaoParaListaCompletaDe1a100FizzBuzzStage2() {
        FizzBuzz fizzBuzz = new FizzBuzz();
        fizzBuzz.gerarListaCompletaAte100FizzBuzzStage2();
    }
}